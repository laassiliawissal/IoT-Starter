...
After you start your Internet of Things Platform Starter instance, open the temperature and humidity sensor simulator from [simulator](https://quickstart.internetofthings.ibmcloud.com/iotsensor/), so that you can connect it to the IBM IoT app.
